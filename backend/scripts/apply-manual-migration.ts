...
async function applyManualMigration() {
  try {
    console.log('Applying manual migration for enhanced memory system...')

    // Add new columns to user_memories table
    await prisma.$executeRaw`ALTER TABLE "user_memories" 
    ...
    console.log('Added new columns to UserMemory table')
    ...
    console.log('Created new tables for enhanced memory system')
    ...
    console.log('Created indexes for enhanced memory system')
