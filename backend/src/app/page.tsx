...
// Removed heavy Dither background for performance
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-neutral-900 dark:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        {/* Subtle background only in dark mode */}
        <div className="absolute inset-0 -z-10 dark:bg-[radial-gradient(ellipse_at_top,_rgba(124,58,237,0.18),_transparent_60%)]" />
        <div className="absolute inset-0 -z-10 dark:bg-[radial-gradient(ellipse_at_bottom,_rgba(59,130,246,0.12),_transparent_55%)]" />
        {/* Bottom fade only in dark mode */}
        <div className="absolute bottom-0 left-0 right-0 h-32 dark:bg-gradient-to-t dark:from-black dark:to-transparent z-0"></div>
        ...
        <div className="relative z-20 container mx-auto px-4 lg:px-8 grid lg:grid-cols-[2fr_1fr] gap-8 lg:gap-16 items-center">
          ...
          <div className="max-w-5xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            <div className="mb-14">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold dark:text-white text-neutral-900 leading-tight mb-8">
              ...
              <p className="text-2xl md:text-3xl dark:text-purple-100 text-purple-700 font-medium leading-relaxed max-w-3xl">
            ...
            <div className="space-y-8 mb-12">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-lg dark:text-white/90 text-neutral-800 leading-relaxed">
              ...
              <p className="text-xl dark:text-white/85 text-neutral-700 leading-relaxed max-w-2xl font-medium">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <SignedOut>
                  <Link href="/register">
                    <Button
                      size="lg"
                      className="bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-700 hover:to-violet-600 text-white backdrop-blur-sm transition-transform duration-300 hover:-translate-y-0.5 px-10 py-5 text-xl font-bold shadow-xl shadow-purple-500/25 rounded-xl"
                    >
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-8 text-sm dark:text-white/60 text-neutral-600">
      ...
      <section className="relative z-10 py-12 sm:py-16 lg:py-20 bg-white dark:bg-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10 sm:mb-14">
              <h2 className="text-3xl sm:text-4xl font-semibold dark:text-white text-neutral-900 mb-3">Powerful Multimodal AI</h2>
              <p className="dark:text-white/70 text-neutral-600 text-base sm:text-lg">Create and understand images, and analyze documents — all in one place.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              {/* Image Generation */}
              <div className="rounded-2xl p-6 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                <div className="w-12 h-12 bg-fuchsia-500/30 rounded-xl flex items-center justify-center mb-5">
                  <div className="w-6 h-6 bg-fuchsia-400 rounded-full"></div>
                </div>
                <h3 className="dark:text-white text-neutral-900 text-xl font-semibold mb-2">Image Generation</h3>
                <p className="dark:text-white/75 text-neutral-700 text-sm leading-relaxed">Turn prompts into high-quality images with style and composition controls.</p>
              </div>

              {/* Image Editing */}
              <div className="rounded-2xl p-6 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                <div className="w-12 h-12 bg-emerald-500/30 rounded-xl flex items-center justify-center mb-5">
                  <div className="w-6 h-6 bg-emerald-400 rounded-full"></div>
                </div>
                <h3 className="dark:text-white text-neutral-900 text-xl font-semibold mb-2">Image Editing</h3>
                <p className="dark:text-white/75 text-neutral-700 text-sm leading-relaxed">Edit, inpaint, and enhance images with mask-aware controls and iterations.</p>
              </div>

              {/* Vision */}
              <div className="rounded-2xl p-6 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                <div className="w-12 h-12 bg-indigo-500/30 rounded-xl flex items-center justify-center mb-5">
                  <div className="w-6 h-6 bg-indigo-400 rounded-full"></div>
                </div>
                <h3 className="dark:text-white text-neutral-900 text-xl font-semibold mb-2">Vision</h3>
                <p className="dark:text-white/75 text-neutral-700 text-sm leading-relaxed">Understand and describe images: extract text, summarize scenes, and answer questions.</p>
              </div>

              {/* Document Analysis */}
              <div className="rounded-2xl p-6 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                <div className="w-12 h-12 bg-amber-500/30 rounded-xl flex items-center justify-center mb-5">
                  <div className="w-6 h-6 bg-amber-400 rounded-full"></div>
                </div>
                <h3 className="dark:text-white text-neutral-900 text-xl font-semibold mb-2">Document Analysis</h3>
                <p className="dark:text-white/75 text-neutral-700 text-sm leading-relaxed">Analyze PDFs, DOCX, and web pages: summarize, extract tables, and answer questions.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Features Section */}
      <section className="relative z-10 py-8 sm:py-12 lg:py-16 bg-white dark:bg-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16 sm:mb-20">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light dark:text-white text-neutral-900 mb-6 leading-tight">
                <ShinyText text="Intelligence Without Surveillance" speed={3} className="dark:text-white text-neutral-900" />
              </h2>
              <div className="max-w-2xl mx-auto">
                <TextType
                  ...
                  showCursor={true}
                  cursorCharacter="|"
                  className="dark:text-white/70 text-neutral-600 text-lg sm:text-xl"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 auto-rows-fr">
              {/* Card 1 - Large */}
              <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5 md:col-span-2 lg:col-span-2">
                <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mb-6">
                  <div className="w-6 h-6 bg-purple-400 rounded-full"></div>
                </div>
                <h3 className="dark:text-white text-neutral-900 text-xl lg:text-2xl font-semibold mb-4">Privacy-First by Design</h3>
                <p className="dark:text-white/70 text-neutral-700 leading-relaxed text-base lg:text-lg">
              ...
              {/* Card 2 - Small */}
              <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                ...
                <h3 className="dark:text-white text-neutral-900 text-lg lg:text-xl font-semibold mb-4">Persistent Memory</h3>
                <p className="dark:text-white/70 text-neutral-700 leading-relaxed text-sm lg:text-base">
              ...
              <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                ...
                <h3 className="dark:text-white text-neutral-900 text-lg lg:text-xl font-semibold mb-4">Performance Without Price Gouging</h3>
                <p className="dark:text-white/70 text-neutral-700 leading-relaxed text-sm lg:text-base">
              ...
              {/* Card 7 - Small */}
              <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-12">
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm">
                  <h3 className="dark:text-white text-neutral-900 text-lg font-semibold mb-4">Adaptive Learning</h3>
                  <ScrambledText
                ...
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm">
                  <h3 className="dark:text-white text-neutral-900 text-lg font-semibold mb-4">Dynamic Code Generation</h3>
              ...
              <div className="space-y-8">
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                  <div className="w-12 h-12 bg-blue-500/30 rounded-xl flex items-center justify-center mb-6">
                    <div className="w-6 h-6 bg-blue-400 rounded-full"></div>
                  </div>
                  <h3 className="dark:text-white text-neutral-900 text-2xl font-semibold mb-4">Dynamic Content Generation</h3>
                ...
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                  ...
                  <h3 className="dark:text-white text-neutral-900 text-2xl font-semibold mb-4">Contextual Understanding & Refinement</h3>
                  <p className="dark:text-white/80 text-neutral-700 text-lg leading-relaxed">
                ...
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
                  ...
                  <h3 className="dark:text-white text-neutral-900 text-2xl font-semibold mb-4">Memory Mindmap Visualization</h3>
                  <p className="dark:text-white/80 text-neutral-700 text-lg leading-relaxed">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 auto-rows-fr">
              {/* Testimonial 1 */}
              <div className="group bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-500 hover:-translate-y-1 min-w-0">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h4 className="dark:text-white text-neutral-900 font-semibold">Sarah Chen</h4>
                    <p className="dark:text-white/60 text-neutral-600 text-sm">AI Researcher, TechCorp</p>
                  </div>
                </div>
                <div className="mb-4">
                  ...
                  <ScrambledText
                    className="dark:text-white/90 text-neutral-800 text-base sm:text-lg leading-relaxed break-normal !m-0 !max-w-none !font-sans !text-base sm:!text-lg"
                    radius={60}
                    duration={0.8}
                    speed={0.4}
                    scrambleChars="★☆✦✧"
              ...
              {/* Testimonial 2 */}
              <div className="group bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-500 hover:-translate-y-1 lg:mt-8 min-w-0">
                <div className="flex items-center mb-4">
              ...
              {/* Testimonial 3 */}
              <div className="group bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 lg:p-8 shadow-sm transition-transform duration-500 hover:-translate-y-1 lg:mt-16 min-w-0">
                <div className="flex items-center mb-4">
      ...
      {/* Pricing Section */}
      <section className="relative z-10 py-32 bg-white dark:bg-transparent">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="dark:text-white/70 text-neutral-600 text-xl max-w-3xl mx-auto mb-8">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-br from-purple-500/20 to-violet-500/20 backdrop-blur-xl border-2 border-purple-400/30 rounded-2xl p-6 relative order-first lg:order-2">
                  ...
                  <SignedOut>
                    <Link href="/register">
                      <Button className="w-full mt-6 bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-semibold py-3 rounded-xl transition-transform duration-300 shadow-lg shadow-purple-500/25">
                        Start Saving Today
                ...
                {/* ChatGPT Card */}
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-sm order-2 lg:order-3">
                  <div className="text-center mb-4">
                    <h3 className="dark:text-white text-neutral-900 font-semibold text-lg mb-2">ChatGPT Plus</h3>
                    <div className="text-neutral-500 dark:text-gray-400 text-3xl font-bold line-through opacity-75">$20</div>
                    <div className="dark:text-white/60 text-neutral-600 text-sm">/month</div>
                    <div className="text-neutral-600 dark:text-gray-300 text-sm mt-1">$240/year</div>
                  </div>
                  <div className="space-y-3">
                ...
                {/* Claude Card */}
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-sm order-3 lg:order-4">
                  <div className="text-center mb-4">
                ...
                {/* Gemini Card */}
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-6 shadow-sm order-4 lg:order-5">
                  <div className="text-center mb-4">
              ...
              {/* Bottom CTA */}
              <div className="text-center bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl p-8 shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <SignedOut>
                    <Link href="/register">
                      <Button className="bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-semibold px-8 py-3 rounded-xl transition-transform duration-300 shadow-lg shadow-purple-500/25">
                        Join Lotus Today
            ...
            <div className="mt-20 pt-16 border-t border-white/10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl p-6 shadow-sm">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
              ...
              <div className="sm:col-span-2 lg:col-span-1">
                ...
                <div className="dark:text-white/70 text-neutral-600 text-sm leading-relaxed mb-6">
                  <TextType
                    text={[
                    ...
                    pauseDuration={3000}
                    showCursor={false}
                    className="dark:text-white/70 text-neutral-600"
                    variableSpeed={undefined}
                    onSentenceComplete={undefined}
                  />
                </div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 dark:bg-white/10 dark:hover:bg-white/20 bg-black/5 hover:bg-black/10 rounded-full flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5">
              ...
              <div>
                <h4 className="dark:text-white text-neutral-900 font-semibold mb-4 sm:mb-6">
                  <ShinyText text="Product" speed={4} className="dark:text-white text-neutral-900" />
                </h4>
            ...
            <div className="dark:bg-white/5 bg-black/5 backdrop-blur-sm border dark:border-white/10 border-black/10 rounded-2xl p-6 sm:p-8 mb-8 sm:mb-12">
              <div className="max-w-2xl mx-auto text-center">
                <h3 className="dark:text-white text-neutral-900 text-lg sm:text-xl font-semibold mb-4">Stay in the Flow</h3>
            ...
            <div className="pt-6 sm:pt-8 border-t dark:border-white/10 border-black/10">
              <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-center sm:text-left">
                <div className="dark:text-white/60 text-neutral-500 text-xs sm:text-sm order-2 sm:order-1 min-w-0 flex-shrink-0">
                  <ScrambledText
                    className="dark:text-white/60 text-neutral-600 whitespace-nowrap"
                    radius={30}
                    duration={0.5}
                    speed={0.2}
                    scrambleChars="©®™"
